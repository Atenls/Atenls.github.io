...
物品价格为「最低交易数量」的价格。<br>
参考：如果你想将某材料以<span style="color: #282930; font-weight: 600;">「5000 dPe / 组」</span>的价格出售，应设置价格为 <span style="color: #282930; font-weight: 600;">5000</span> 而非 5000/64 ≈ 78。
</p>
...
最终的税率计算逻辑是： `总价 * 基准税率 * (100% - 减免税率)`

同样以 `1000` 举例，假设玩家为 `c3` 月卡用户，则最终的税率为：`1000 * 5% * (100% - 30%)` = 35，即最终可收到 `965` 。
