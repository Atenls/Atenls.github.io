...
<br><br>
Rapids 的设计目标为轻任务模式，玩家将不需要投入过高的精力，在完成部分日常循环/周常循环任务后将获得大部分奖励。<br>
而在日常游玩中，核心的物资收集也将受体力限制。其余情况，收益略低，但也仍可在开放副本中进行资源获取。
<br><br>
...
Rapids 的 Alpha 测试大约将在 `Jun 2026` 的 `第三周` 开始。<br>
