...
<div class="table-container">
  <table style="border-collapse: collapse; overflow: hidden; width: fit-content; font-family: 等线; text-align: center; border-image: initial; vertical-align: middle; white-space: nowrap; margin: 5px; padding: 16px; border-radius: 24px; border: 1px solid #ccc;" class="rune-table">
    <thead><tr style="background: #7367aa; boder-radius: 24px;">
        <th style="border: none;"><span style="color: white;">功能</span></th>
        <th width="150px"><span style="color: #cc90cc;">Noctambulist</span></th>
    ...
    <tbody>
      ...
      <tr><td>QS 容量</td><td>1280 (+100%)</td><td>2400 (+275%)</td><td>4096 (+540%)</td></tr>
      <tr><td>US 容量</td><td>+27</td><td>+54</td><td>+81</td></tr>
      <tr><td>交易所托管槽位</td><td>+9</td><td>+18</td><td>+27</td></tr>
      ...
      <tr><td>钓鱼自动出售</td><td></td><td>✔</td><td>✔</td></tr>
    </tbody>
  </table>
</div>
